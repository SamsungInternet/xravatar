...
import { getXRAvatarRoot, getUIData, getCategoriesInTraverseOrder, getUniforms } from './gltfparse.js';
import { updatePaletteCanvas } from './canvasPaletteMap.js';
...
(async function init() {
	...
	updatePaletteCanvas(uniforms, palette);
