...
import { getXRAvatarRoot, getUIData } from './gltfparse.js';
...
(async function init() {
	...
	const state = new Map();// await getState(); // State which is saved & sent to the client
	...
	const updateGLState = renderGL(canvas, xravatarRoot, uiData);
